        ...
        <>
            <Button className="countryDrop" onClick={() => setisOpenModal(true)}>
                <div className="info d-flex flex-column">
                    ...
                    <span className='name'>See Locations</span>
            ...
            <Dialog open={isOpenModal} className='locationModal' onClose={() => setisOpenModal(false)} TransitionComponent={Transition}>
                ...
                <Button className='close_' onClick={() => selectCountry(index)}><IoClose /></Button>

                <div className="headerSearch w-100">
                    <input type='text' placeholder='Search your location here.' />
                ...
                <ul className='countryList mt-3'>

                    {
                        MyContext.countryList?.length !== 0 && context.countryList?.map((item, index) => {
                            return (
                                <li key={index}><Button onClick={() => setisOpenModal(false)} 
